...
//import interface
import partb.servers.serverb2.ServerB2Interface;
...
public class ServerB2 implements ServerB2Interface{
  ...
  public static void main(String args[]){
    try{
      ...
      ServerB2Interface stub = (ServerB2Interface) UnicastRemoteObject.exportObject(obj, 0);

      //get Registry
      Registry registry = LocateRegistry.getRegistry(host, port);

      //Bind the remote object's stub in the Registry
      registry.bind("FTPB2", stub);
...
*/
  ...
  public byte[] listFilesOnServer() throws SocketException, IOException{
      ...
      File directory = new File(stringPath + "\\partb\\servers\\serverb2\\Storage\\");
